...
export async function checkUntilEq(async_fn: Function, expected, timeout: number, verbose=true) {
    const t0 = new Date().getTime();
...
export async function blockBarrier(api: any, prpc: any, finalized=false, timeout=4*6000) {
